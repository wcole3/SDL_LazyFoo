...
bool lTexture::loadFromFile(std::string path, SDL_bool colorKey){
    free();
    ...
    if(loadedSurface==NULL){
        ...
        //color key here if need; should change this to make it possible in the call to specify the color
        SDL_SetColorKey(loadedSurface, colorKey, SDL_MapRGB(loadedSurface->format, 255, 255, 255));
